...
def capture_photos():
    ...
    while running:
        if is_recording.is_set():  # 주행 중일 때만 촬영
            ...
            if ret:
                # 조향 값 추가
                text = f"Steering Angle: {servo_angle}°"
                ...
                photo_count += 1
            time.sleep(0.5)  # 약 2fps로 촬영 (간격 조절 가능)
