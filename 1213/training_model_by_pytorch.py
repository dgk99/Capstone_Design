...
class DrivingDataset(Dataset):
    def __init__(self, csv_file, transform=None):
        ...
        self.base_dir = "C:\\Users\\USER\\Desktop\\DGK\\mygithub\\Capstone_Design"  # 폴더 이름 수정
...
dataset = DrivingDataset(csv_file='driving_data_20241213_192414.csv', transform=transform)
